<%@ Page Title="" Language="C#" MasterPageFile="~/Account/TechPrint.Master" AutoEventWireup="true" CodeBehind="PaymentSummery.aspx.cs" Inherits="TechPrint.Report.PaymentSummery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <center>
                <table>
                    ...
                    <tr class="head_tag">
                        <td colspan="4">
                          &nbsp; DATE WISE PAYMENT / OUTSTANDING SUMMERY REPORT
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="3">
                            <asp:RadioButton ID="rbtnPaymentSummery" runat="server" GroupName="Report" Text="Payment Summery"></asp:RadioButton>
                            <asp:RadioButton ID="rbtnOutstanding" runat="server" GroupName="Report" Text="Outstanding Summery"></asp:RadioButton>
                        </td>
                    </tr>
                    <tr>
                        <td>
